...
export class ManageGroupDialog extends ComfyDialog {
  ...
  getEditElement(section, prop, value, placeholder, checked, checkable = true) {
    ...
    return $el('div', [
      ...
      $el('label', { textContent: _t('Visible') }, [
        $el('input', {
          type: 'checkbox',
          checked,
          disabled: !checkable,
  ...
  show(type) {
    ...
    this.tabs = [
      [_t('Inputs'), this.inputsPage],
      [_t('Widgets'), this.widgetsPage],
      [_t('Outputs'), this.outputsPage],
    ].reduce((p, [name, page]) => {
      p[name] = {
        tab: $el('a', {
          onclick: () => {
